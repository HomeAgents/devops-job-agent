...
_KNOWN_TOP_KEYS = {
    ...
    "linkedin_posts",
    "google_web_browser",
    "ats_google_site_search",
    "serpapi_features",
    "greenhouse_boards",
    "lever_sites",
    "rss_feeds",
    "rss_feeds_israel_host_substrings",
    "comeet",
    "scoring",
    "role_focus",
    "location_hint",
    "location_hint_aliases",
    "location_hint_strict_location_or_title",
    "location_hint_include_job_description",
    "location_hint_description_max_chars",
    "location_filter_mode",
    "location_filter_source_prefixes",
    "filter_jobs_by_location_hint",
    "max_posted_age_days",
    "keep_unknown_posted_age",
    "digest_remove",
    "digest_ignore_links",
    "digest_ignore_companies",
    "digest_min_minutes_between_sends",
    "digest_include_jobs_seen_within_days",
    "digest_email_only_new",
    "digest_email_subjects",
    "digest_email_include_removed_table",
    "digest_email_collapsible_tables",
    "digest_email_enforce_location_hint",
    "digest_send_state_file",
    "email_attach_excel",
